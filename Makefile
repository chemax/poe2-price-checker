...
.PHONY: db-up db-down db-logs migrate-up migrate-down migrate-version ref-sync trade2-stats-sync mod-match build
...
trade2-stats-sync:
	DATABASE_DSN=$${DATABASE_DSN:-postgres://poe2:poe2@127.0.0.1:5432/poe2?sslmode=disable} go run ./cmd/trade2statssync
